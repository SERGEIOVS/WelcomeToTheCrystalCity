...
hero_inventory_file = open (hero_inventory_file_name , hero_inventory_file_mode , encoding= "utf-8") ; hero_inventory_file1 = hero_inventory_file.readlines()
prices_file = open(prices_file_name , prices_file_mode , encoding= "utf-8") ; prices_file1 = prices_file.readlines()



for i in range(show_vars["show_variables"]) :
    ...
    show_game_state           = big_font.render(str(show_vars["show_variables"]["game_state"]) , False , small_font_color)
    ...
    show_fuel          = big_font.render('Fuel  : ' + str(show_vars["show_variables"]["fuel"]) , False , small_font_color ) 
    show_mods_count = big_font.render("(" + str(len(os.listdir(show_vars["show_variables"]["mods_dir_path"]))) + ")" , False , small_font_color ) 
...
for i in range(show_vars["variables"]["volume_levels"]):
    i += 1
    i = show_vars["lists"]["Colors_Coords_x_1"].append( i * 100)
    i = show_vars["lists"]["Colors_Coords_y_1"].append(400)
